 ...
 * every lead. Use it to practice sub-five-minute response, not as a channel.
 */
...
export const CAMPAIGNS: Campaign[] = [
  ...
  },
  {
    ...
    bullets: [
      'Built on Next.js, so you get the repository, not a license to a page builder',
  ...
  },
  {
    ...
    bullets: [
      ...
      'SVG and PNG at every size, plus the editable source files, with no "we keep the working files"',
      'Font licenses documented, so you know exactly what you can use commercially',
    ],
    proof:
  ...
  },
  {
    ...
    bullets: [
      'Half-day audit first, and we tell you what is not worth automating as well as what is',
      'Built in n8n, self-hostable and open, so the workflows stay yours and cost does not scale with volume',
      'AI where judgment is needed, plain rules everywhere else, because rules do not hallucinate or bill per token',
