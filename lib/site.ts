...
export const SITE = {
   ...
   * e.g. '19295632844' for +1 929 563 2844, or '923012661331' for a PK number.
   *
   ...
   * Use a number someone actually watches during 8am–1pm US Eastern — a
   * WhatsApp button that goes unanswered for six hours is worse than none.
   */
  whatsapp: '',
  ...
  /** Second location. Stated plainly, ordered second. Blueprint §2.5. */
  engineering: {
    city: 'Karachi',
    country: 'Pakistan',
  },
  ...
  differentiators: [
    {
      title: '5 hours of overlap, every working day',
      body: 'Your morning is our afternoon. 8am–1pm US Eastern, Monday to Friday, on a calendar you can book — not "we\'re flexible".',
    },
    {
      title: 'You own the code from day one',
      body: 'Work product is yours the instant it is written. Not on delivery. Not on final payment. It is in the contract, not just on this page.',
    },
    {
    ...
    },
    {
      ...
      body: 'US bank account, W-9 on file, invoices in USD. Nothing for your finance team to escalate. No international wires.',
    },
  ],
   ...
   * ~70% better lead quality. With Bark/Meta traffic that trade favours you.
   *
 ...
 * A required budget field is the cheapest tyre-kicker filter you have.
 *
...
export const STARTER_PACKS = [
  {
    ...
    includes: [
      ...
      'Colour palette, typography and usage rules in a one-page guide',
      'Files for web, print and social — SVG, PNG, PDF',
      'Full ownership transferred to you in writing',
    ],
  ...
  },
  {
    ...
    includes: [
      'Storefront with up to 50 products loaded and categorised',
 ...
 * LinkedIn links, is the cheapest and strongest trust asset available, and no
 * comparable Pakistani-origin agency does it.
 *
 ...
 *
 *  3. IT SPOTLIT THE GAP. For a company selling to US buyers, a roster of
 *     non-US names does not close the offshore objection; it draws a circle
 *     around it. Better to state the location plainly, as the site now does
 *     everywhere, and compete on terms rather than on optics.
 *
 ...
 * ALONGSIDE the commitments, never instead of them. A single named, verifiable
 * US-based partner remains the strongest addition this site could ever make.
 */
